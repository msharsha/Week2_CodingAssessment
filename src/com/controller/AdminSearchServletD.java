...
/**
 * Servlet implementation class AdminSearchServletD
 */
public class AdminSearchServletD extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSearchServletD() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd =request.getRequestDispatcher("AdminSearchDelete.jsp");
